        ...
        <article className="projects">
          ...
          <div className="project">
            ...
            <div className="project__info">
              ...
              <p>
                Un sitio web de alquiler de automóviles es una plataforma en
                línea que permite a los usuarios alquilar automóviles para uso
                personal o comercial. El sitio web proporciona una interfaz para
                buscar, comparar y reservar coches
              </p>
              <div className="project__info__buttons">
                <a>
                  Código <img src={github} alt="" />
                </a>
                <a>
                  Ver <img src={share} alt="" />
                </a>
              </div>
            </div>
          </div>
      ...
      <section id="contact" className="section3">
        ...
        <div className="contact__container">
          <div className="contact__item">
            <a className="contact__item__icon" href="mailto:marcoagudo21@gmail.com" target="_blank" rel="noopener noreferrer">
              <svg
            ...
            <div className="contact__item__info">
              <h4>Mail</h4> <a href="mailto:marcoagudo21@gmail.com" target="_blank" rel="noopener noreferrer">marcoagudo21@gmail.com</a>
            </div>
          </div>
          <div className="contact__item">
            <a className="contact__item__icon" href="https://www.linkedin.com/in/marco-agudo-487225287/" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="30"
            ...
            <div className="contact__item__info">
              <h4>LinkedIn</h4> <a href="https://www.linkedin.com/in/marco-agudo-487225287/" target="_blank" rel="noopener noreferrer">@MarcoAgudo</a>
            </div>
          </div>
          <div className="contact__item">
            <a className="contact__item__icon" href="https://wa.me/+541124539499" target="_blank" rel="noopener noreferrer">
              <svg
                fill="#000000"
                width="30"
                height="30"
